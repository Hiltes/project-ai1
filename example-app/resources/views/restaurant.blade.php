                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="bg-gray-100 p-6 rounded-xl border border-gray-100">
                        ...
                        <div class="space-y-2 text-gray-700 text-sm leading-relaxed">
                            <p><span class="font-semibold text-gray-800">Opis:</span> {{ $restaurant->description ?: 'Brak opisu.' }}</p>
                            <p><span class="font-semibold text-gray-800">Opłata za dostawę:</span> {{ number_format($restaurant->delivery_fee, 2) }} zł</p>
                            @if ($restaurant->owner)
                                <p><span class="font-semibold text-gray-800">Właściciel:</span> {{ $restaurant->owner->name }}</p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-100 p-6 rounded-xl border border-gray-100">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 text-sm mt-4">
                            <tbody class="bg-gray-100 divide-y divide-gray-200">
                                <tr><td class="px-4 py-2 font-medium text-gray-700">Poniedziałek - Piątek</td><td class="px-4 py-2 text-gray-600">8:00 - 22:00</td></tr>
                                <tr><td class="px-4 py-2 font-medium text-gray-700">Sobota</td><td class="px-4 py-2 text-gray-600">9:00 - 23:00</td></tr>
                                <tr><td class="px-4 py-2 font-medium text-gray-700">Niedziela</td><td class="px-4 py-2 text-gray-600">10:00 - 21:00</td></tr>
                            </tbody>
                        </table>
                    </div>
                            ...
                            <div class="space-y-4">
                                @foreach($reviews as $review)
                                    <div class="bg-white p-4 rounded-lg shadow-md border border-gray-100">
                                        ...
                                        <div class="text-sm text-gray-500">Dodano: {{ \Carbon\Carbon::parse($review->created_at)->format('d.m.Y') }}</div>
                                    </div>
                                @endforeach
                            </div>
                        @else
                            <p class="text-gray-600">Brak opinii dla tej restauracji. Bądź pierwszą osobą, która ją oceni!</p>
                        @endif
                    </div>
