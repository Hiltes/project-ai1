<x-layouts.app :title="'Lista Użytkowników'">
    <main class="flex-grow">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="sm:flex sm:items-center sm:justify-between mb-8">
                <div class="mb-4 sm:mb-0">
                    <h1 class="text-3xl font-bold text-emerald-700">Zarządzanie użytkownikami</h1>
                    <p class="mt-2 text-sm text-gray-600">Lista wszystkich użytkowników zarejestrowanych w systemie</p>
                </div>
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-2xl">
                ...
                @forelse($users as $user)
                    <div
                        ...
                        <div class="col-span-5 md:col-span-4">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 bg-emerald-100 rounded-full flex items-center justify-center">
                                    <span class="text-emerald-700 font-bold uppercase">{{ strtoupper(substr($user->name, 0, 1)) }}</span>
                                </div>
                                <div class="ml-4">
                                    ...
                                    <p class="text-base text-gray-600 mt-1">{{ $user->email }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="hidden md:col-span-4 md:block">
                            ...
                            <p class="text-sm text-gray-500">Utworzono: {{ $user->created_at->format('d.m.Y') }}</p>
                        </div>

                        <div class="col-span-4 md:col-span-2">
                            <div class="flex justify-end space-x-2">
                                <a href="{{ route('admin.users.edit', $user) }}" style="background-color: #1fa37a;"
                ...
                @empty
                    <div class="px-6 py-12 text-center">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Nie dodano jeszcze żadnych użytkowników do systemu.</p>
                        <div class="mt-6">
                            <a href="{{ route('admin.users.create') }}" style="background-color: #1fa37a;"
