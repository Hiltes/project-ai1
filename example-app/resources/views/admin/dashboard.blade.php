<x-layouts.app :title="'Panel administratora'">
    ...
    <section class="max-w-7xl mx-auto px-6 py-6">
        <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div class="bg-white p-6 rounded-lg shadow text-left">
                <h3 class="text-xl font-bold mb-2 text-[#1fa37a]">Zarządzanie restauracjami</h3>
                <p class="text-gray-600 mb-4">Zarządzaj restauracjami na platformie</p>
                <a href="{{ route('admin.restaurants.index') }}" class="text-[#1fa37a] font-medium hover:underline">Przejdź do zarządzania restauracjami</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow text-left">
                ...
                <a href="{{ route('admin.users.index') }}" class="text-[#1fa37a] font-medium hover:underline">Przejdź do zarządzania użytkownikami</a>
            </div>
